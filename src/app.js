      ...
      return res
        ...
        .json(
          formatErrorResponse(
            'NOK',
            403,
            'Access denied: Requests must include a valid Origin header. Non-browser clients (e.g., Postman, curl) are not allowed.',
          ),
        );
      ...
      return res
        ...
        .json(
          formatErrorResponse(
            'NOK',
            403,
            'CORS policy: This origin is not allowed to access the API.',
          ),
        );
